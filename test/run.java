...
void main(String[] arguments) {
    var suites = List.of(
            ...
            new Named("eventstream.EventStreamHttpTest", eventstream.EventStreamTest::integration),
            ...
            new Named("web.HttpIntegrationTest", web.WebTest::integration),
...
private static final Set<String> INTEGRATION = Set.of(
        ...
        "symbols.StoreTest",
        "eventstream.EventStreamHttpTest",
        "web.HttpIntegrationTest",
        "web.cable.CableTest",
